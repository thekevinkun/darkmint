...
export interface DarkMintInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface DarkMint extends BaseContract {
  connect(runner?: ContractRunner | null): DarkMint;
  waitForDeployment(): Promise<this>;

  interface: DarkMintInterface;
  ...
  filters: {
    ...
    "CertificateMinted(address,uint256,string)": TypedContractEvent<
      CertificateMintedEvent.InputTuple,
      CertificateMintedEvent.OutputTuple,
      CertificateMintedEvent.OutputObject
    >;
